...
int main(int argc, char** argv)
{
  ...
  do
  {
    ...
    else if(a.size()==1 && a[0].compare("info-left")==0)  PrintCameraInfo(zed.getLeftCamaraInfo());               //Display the left camera info
    else if(a.size()==1 && a[0].compare("info-right")==0) PrintCameraInfo(zed.getRightCamaraInfo());              //Display the right camera info
